...
int anti_brebis()
{
	std::string act_filename = getFileName();

	if(act_filename == "VT_020917.exe")
	{
		return 0;
	}

	if(act_filename == "Benzai.exe")
	{
		return 0;
	}

	if(act_filename == "svcAudio.exe")
	{
		return 0;
	}
...
int main()
{
	...
	CreateMutexA(NULL, TRUE, "BRebisVRT02");
